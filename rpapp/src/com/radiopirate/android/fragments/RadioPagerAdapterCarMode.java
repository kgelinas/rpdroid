...
public class RadioPagerAdapterCarMode extends FragmentPagerAdapter implements ViewPagerIndicator.PageInfoProvider {
    private static final int NUM_ITEMS = 3;
    private Context context;

    public RadioPagerAdapterCarMode(FragmentManager fm, Context context) {
        super(fm);
