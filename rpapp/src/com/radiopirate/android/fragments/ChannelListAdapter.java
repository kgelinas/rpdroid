    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (entry != null) {
            ...
            if (channelImage != null) {
                ...
                if (RPSettings.showChannelImage()) {
                    channelImage.setImageResource(RPSettings.getChannelImage(entry.getChannelId()));
                } else {
            ...
            if (channelDescription != null) {
                channelDescription.setText(RPSettings.getInstance().getChannelDescription(res, entry.getChannelId()));
            }
        }
        return v;
    }
